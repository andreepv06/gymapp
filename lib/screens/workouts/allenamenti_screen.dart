...
class _AllenamentiScreenState extends State<AllenamentiScreen> {
  ...
  Future<void> _handlePlayTap(BuildContext ctx, HiveWorkout workout) async {
    ...
    if (sp.hasPausedSessionForWorkout(workout.key)) {
      ...
      final result = await showGlassDialog<String>(
        context: ctx, accentColor: _orange,
        icon: Container(width: 44, height: 44,
          decoration: BoxDecoration(
        ...
        actions: [
          GlassDialogAction(label: 'Riprendi sessione', isDefault: true,
              color: _orange, onTap: () => Navigator.pop(ctx, 'resume')),
  ...
  void _handleEditTap(HiveWorkout workout) {
    ...
    pushPage(context, WorkoutDetailScreen(
        workoutId: workout.key, workoutName: workout.name));
  }
            ...
            children: [
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                _GestioneEserciziPill(
                  onLibrary:     () => pushPage(context, const ExercisesScreen()),
              ...
              if (sp.hasPausedSessions) ...[
                ...
                ...sp.pausedSessions.map((data) => Padding(
                  ...
                  child: _PausedSessionPanel(
                    ...
                    onDelete: () async {
                      final id = data['id'] as String?;
                      if (id != null) await sp.deletePausedSession(id);
                    }))),
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(begin: Alignment.topLeft,
              ...
              colors: [const Color(0xFF1E3A8A).withOpacity(0.4),
...
class _PausedSessionPanel extends StatelessWidget {
  ...
  String _name() {
    ...
    try {
      return HiveDatabase.instance.getWorkouts()
          .firstWhere((w) => w.key == wk).name;
    } catch (_) { return 'Sessione in pausa'; }
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              Wrap(spacing: 8, runSpacing: 6, children: [
                _StatChip(icon: Icons.timer_outlined,
                    label: _fmt(elapsed), color: _orange),
                _StatChip(icon: Icons.access_time_rounded,
                    label: _age(), color: _orange),
            ...
            boxShadow: [
              if (c.showElevation)
                BoxShadow(color: c.elevationColor, blurRadius: 20,
                    offset: const Offset(0, 4)),
              BoxShadow(color: _teal.withOpacity(0.12), blurRadius: 32,
                  spreadRadius: 1),
            ]),
          child: Padding(
            ...
            child: Column(
              ...
              Row(children: [
                Container(padding: const EdgeInsets.all(8),
                  decoration: BoxDecoration(
                    color: _teal.withOpacity(0.15), shape: BoxShape.circle),
                  child: const Icon(Icons.bolt_rounded, color: _teal, size: 18)),
                const SizedBox(width: 12),
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              ...
              BoxShadow(color: (indicator ?? _teal).withOpacity(0.15),
                  blurRadius: 20),
            ]),
          child: Padding(
            padding: const EdgeInsets.all(18),
