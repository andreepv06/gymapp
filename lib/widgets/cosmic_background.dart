...
//
// DARK: spazio cosmico con stelle animate (Jarvis HUD)
// LIGHT: gradiente ghiaccio con blobs subtili (iOS Frost Glass)
//
// subtle: true → intensità ridotta (schermate secondarie pushed)
// ─────────────────────────────────────────────────────────────

class CosmicBackground extends StatefulWidget {
  final Widget child;

  /// Quando true riduce l'intensità del background:
  /// - dark:  meno stelle (40 invece di 70), opacità −40%
  /// - light: blob più piccoli e più trasparenti
  final bool subtle;
